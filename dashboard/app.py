...
from components.strategy import render render_strategy_controls
from components.performance import render render_performance
from components.current_positions import render render_current_positions
