    ...
    try:
        ...
        for coin, amount in balances.items():
            ...
            coin_state = {
                ...
                "Bollinger": {"amount": 0.0, "buy_price": 0.0, "status": "Inactive", "timestamp": None},
                "RSI_1H":    {"amount": 0.0, "buy_price": 0.0, "status": "Inactive", "timestamp": None},
                "RSI_5M":    {"amount": 0.0, "buy_price": 0.0, "status": "Inactive", "timestamp": None},
                "DCA_Matrix":{"amount": 0.0, "buy_price": 0.0, "status": "Inactive", "timestamp": None}
            }
        ...
        print(f"❌ Failed to save live snapshot and state: {e}")
